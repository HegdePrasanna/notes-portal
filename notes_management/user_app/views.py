...
class RoleView(APIView):
    ...
    def get(self, request):
        ...
        if roles_queryset.exists():
            ...
            return Response({'status': status.HTTP_404_NOT_FOUND, 'detail': 'Roles Not Found. Please Create a Role', 'data':[]},
...
class SingleRoleView(APIView):
    ...
    def get(self, request, pk):
        ...
        try:
            ...
            return Response({'status': status.HTTP_404_NOT_FOUND, 'detail': 'Requested Role Not Found.', 'data':[]}, status=status.HTTP_404_NOT_FOUND)
        role_serializer = serializers.RoleSerializer(role_queryset)
        return Response({'status': status.HTTP_200_OK, 'detail': 'Role successfully retrieved.', 'data':role_serializer.data})
    ...
    def put(self, request, pk):
        ...
        if role_serializer.is_valid():
            ...
            return Response({'status': status.HTTP_200_OK, 'detail': 'Role successfully updated.', 'data':role_serializer.data})
        return Response({'status': status.HTTP_400_BAD_REQUEST, 'detail': 'Unable to update Role.', 'data':role_serializer.errors})
    ...
    def delete(self, request, pk):
        ...
        role_queryset.save()
        return Response({'status': status.HTTP_200_OK, 'detail': 'Role successfully Deleted.', 'data':[]})
...
class UserView(APIView):
    ...
    def get(self, request):
        ...
        if user_queryset.exists():
            ...
            return Response({'status': status.HTTP_404_NOT_FOUND, 'detail': 'User Not Found. Please Create a User', 'data':[]},
                            status=status.HTTP_404_NOT_FOUND)
...
class SingleUserView(APIView):
    ...
    def get(self, request, pk):
        ...
        try:
            ...
            return Response({'status': status.HTTP_404_NOT_FOUND, 'detail': 'Requested User Not Found.', 'data':[]}, status=status.HTTP_404_NOT_FOUND)
        user_serializer = serializers.UserSerializer(user_queryset)
        return Response({'status': status.HTTP_200_OK, 'detail': 'User Details successfully retrieved.', 'data':user_serializer.data})
    ...
    def put(self, request, pk):
        ...
        if user_serializer.is_valid():
            ...
            return Response({'status': status.HTTP_200_OK, 'detail': 'User successfully updated.', 'data':user_serializer.data})
        return Response({'status': status.HTTP_400_BAD_REQUEST, 'detail': 'Unable to update User.', 'data':user_serializer.errors})
